...
encrypted = bobs_box.encrypt(b"I am Bob")

# Alice creates a second box with her private key and Bob's public key
# so that she can decrypt the message
...
encrypted1 = alices_box.encrypt(b"I am Alice")

# Now bob can decrypt the message:
print(bobs_box.decrypt(encrypted1).decode('utf-8'))
